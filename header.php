...
<html <?php language_attributes(); ?>>
    ...
    <body <?php body_class($class); ?>>
        <div class="wrapper">
            <header class="animatedParent animateOnce <?php echo $searchClass; ?>">
                <div class="container">
                    ...
                    <div class="header-mobile-btn">
                        <div class="search-wrap tablet-potrait-show">
                            <a href="#" title="<?php //printf(__('Search', 'karoon')); ?>">
                                <img src="<?php echo get_template_directory_uri(); ?>/public/images/search.svg" alt="<?php _e('Search', 'karoon'); ?>" title="<?php printf(__('Search', 'karoon')); ?>">
                            ...
                            <div class="primary-menu-wrap">
                                ...
                                <div class="search-wrap">
                                    <a href="#" title="<?php //_e('Search', 'karoon'); ?>">
                                        <img src="<?php echo get_template_directory_uri(); ?>/public/images/search.svg" alt="<?php _e('Search', 'karoon'); ?>" title="<?php _e('Search', 'karoon'); ?>">
