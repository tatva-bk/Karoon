...
<main class="inner-page">
    ...
    <section class="section sec__governance governance-page-wrapper">
                                ...
                                <div class="coll-body">
                                    ...
                                    while (have_rows('corporate_policies')) {
                                        ...
                                        <?php if ($countPolicie == 9) { 
                                            ...
                                            <div class="col-12 col-sm-6 col-md-4  corporate-block <?=$hideBlock;?>">
                                            ...
                                            <?php if ($policieTitle && $policieTitle != '') { ?>
                                                    ...
                                                    <?php } ?>
                                                    <i>
                                                        <img src="<?php echo get_template_directory_uri(); ?>/public/images/download-icon-blue.svg" alt="">
                                                    </i>
                                                </a>
                                            <?php }?>
                                            </div>
